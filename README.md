...
# [Schedule](schedule) | [Weekly talk](weekly-talk.md)
...
|2020|Google|FixMatch: Simplifying Semi-Supervised Learning with Consistency and Confidence|    |[NIPS](papers/FixMatch.pdf)|[summary](summary/FixMatch.md)|
...
|2020|Oxford|Semi-Supervised Learning with Scarce Annotations|[Code](https://github.com/srebuffi/semisup_scarse)|[CVPR](papers/SemiSupervisedLearning.pdf)|[Summary](summary/SemiSupervisedLearning.md)| 
...
|   |CCVL|Joint Shape Representation and Classification for Detecting PDAC| |[arXiv](papers/Joint.pdf)| |
...
|2021|Google|Zero-Shot Text-to-Image Generation|    |[arXiv](papers/Zero.pdf)|  |
|2018|Google|Realistic Evaluation of Deep Semi-Supervised Learning Algorithms|  |[NIPS](papers/Realistic.pdf)|  |
|2019|Nvidia|Devil is in the Edges: Learning Semantic Boundaries from Noisy Annotations|    |[CVPR](papers/Devil.pdf)|  |
